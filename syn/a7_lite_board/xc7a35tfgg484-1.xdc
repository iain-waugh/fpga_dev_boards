...
set_property IOSTANDARD LVCMOS33 [get_ports {
    clk rst i_key1 i_key2 o_led1 o_led2 o_uart_tx i_uart_rx 
...
make_diff_pair_ports o_hdmi_clk_p o_hdmi_clk_n
make_diff_pair_ports o_hdmi_d_p[0] o_hdmi_d_n[0]
make_diff_pair_ports o_hdmi_d_p[1] o_hdmi_d_n[1]
make_diff_pair_ports o_hdmi_d_p[2] o_hdmi_d_n[2]
