...
set_property PACKAGE_PIN Y8  [get_ports {io_audio_gpio0}];  # "AC-GPIO0"
set_property PACKAGE_PIN AA7 [get_ports {io_audio_gpio1}];  # "AC-GPIO1"
set_property PACKAGE_PIN AA6 [get_ports {io_audio_gpio2}];  # "AC-GPIO2"
set_property PACKAGE_PIN Y6  [get_ports {io_audio_gpio3}];  # "AC-GPIO3"
...
# ----------------------------------------------------------------------------
# HDMI Output - Bank 33
set_property PACKAGE_PIN W18  [get_ports { o_hd_clk}];     # "HD-CLK"
set_property PACKAGE_PIN V17  [get_ports { o_hd_hsync}];   # "HD-HSYNC"
set_property PACKAGE_PIN W17  [get_ports { o_hd_vsync}];   # "HD-VSYNC"
set_property PACKAGE_PIN Y13  [get_ports { o_hd_d0}];      # "HD-D0"
set_property PACKAGE_PIN AA13 [get_ports { o_hd_d1}];      # "HD-D1"
set_property PACKAGE_PIN AA14 [get_ports { o_hd_d2}];      # "HD-D2"
set_property PACKAGE_PIN Y14  [get_ports { o_hd_d3}];      # "HD-D3"
set_property PACKAGE_PIN AB15 [get_ports { o_hd_d4}];      # "HD-D4"
set_property PACKAGE_PIN AB16 [get_ports { o_hd_d5}];      # "HD-D5"
set_property PACKAGE_PIN AA16 [get_ports { o_hd_d6}];      # "HD-D6"
set_property PACKAGE_PIN AB17 [get_ports { o_hd_d7}];      # "HD-D7"
set_property PACKAGE_PIN AA17 [get_ports { o_hd_d8}];      # "HD-D8"
set_property PACKAGE_PIN Y15  [get_ports { o_hd_d9}];      # "HD-D9"
set_property PACKAGE_PIN W13  [get_ports { o_hd_d10}];     # "HD-D10"
set_property PACKAGE_PIN W15  [get_ports { o_hd_d11}];     # "HD-D11"
set_property PACKAGE_PIN V15  [get_ports { o_hd_d12}];     # "HD-D12"
set_property PACKAGE_PIN U17  [get_ports { o_hd_d13}];     # "HD-D13"
set_property PACKAGE_PIN V14  [get_ports { o_hd_d14}];     # "HD-D14"
set_property PACKAGE_PIN V13  [get_ports { o_hd_d15}];     # "HD-D15"
set_property PACKAGE_PIN U16  [get_ports { o_hd_de}];      # "HD-DE"
set_property PACKAGE_PIN W16  [get_ports { o_hd_int}];     # "HD-INT"
set_property PACKAGE_PIN AA18 [get_ports {io_hd_scl}];     # "HD-SCL"
set_property PACKAGE_PIN Y16  [get_ports {io_hd_sda}];     # "HD-SDA"
set_property PACKAGE_PIN U15  [get_ports { o_hd_spdif}];   # "HD-SPDIF"
set_property PACKAGE_PIN Y18  [get_ports { i_hd_spdifo}];  # "HD-SPDIFO"


# ----------------------------------------------------------------------------
# User LEDs - Bank 33
set_property PACKAGE_PIN T22 [get_ports {o_led0}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {o_led1}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {o_led2}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {o_led3}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {o_led4}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {o_led5}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {o_led6}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {o_led7}];  # "LD7"
...
set_property PACKAGE_PIN V20  [get_ports {o_vga_red0}];    # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {o_vga_red1}];    # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {o_vga_red2}];    # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {o_vga_red3}];    # "VGA-R4"
set_property PACKAGE_PIN AB22 [get_ports {o_vga_green0}];  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {o_vga_green1}];  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {o_vga_green2}];  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {o_vga_green3}];  # "VGA-G4"
set_property PACKAGE_PIN Y21  [get_ports {o_vga_blue0}];   # "VGA-B1"
set_property PACKAGE_PIN Y20  [get_ports {o_vga_blue1}];   # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {o_vga_blue2}];   # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {o_vga_blue3}];   # "VGA-B4"


# ----------------------------------------------------------------------------
# User Push Buttons - Bank 34
set_property PACKAGE_PIN P16 [get_ports {i_btnc}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {i_btnd}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {i_btnl}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {i_btnr}];  # "BTNR"
set_property PACKAGE_PIN T18 [get_ports {i_btnu}];  # "BTNU"
...
set_property PACKAGE_PIN F22 [get_ports {i_sw0}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {i_sw1}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {i_sw2}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {i_sw3}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {i_sw4}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {i_sw5}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {i_sw6}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {i_sw7}];  # "SW7"
